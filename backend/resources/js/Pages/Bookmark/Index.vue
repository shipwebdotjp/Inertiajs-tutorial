<template>
    <layout>
        ...
        <inertia-link as="button" method="post" :href="route('bookmark.store')" :data="{title: newTitle, url: newUrl}" preserve-state class="border border-gray-400 m-1 p-1 text-sm">ブックマーク追加</inertia-link>
